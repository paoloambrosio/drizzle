...
case class TryAction(times: Expression[Int], counterName: String, body: List[GatlingAction]) extends GatlingAction
case object ExitOnErrorAction extends GatlingAction
